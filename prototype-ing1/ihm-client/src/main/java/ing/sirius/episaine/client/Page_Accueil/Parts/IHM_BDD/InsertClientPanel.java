package ing.sirius.episaine.client.Page_Accueil.Parts.IHM_BDD;
...
public class InsertClientPanel extends JPanel implements ActionListener {
    ...
    private JPanel promptPanel() {
        ...
        gbc.gridy = 4; // line 5
        String[] comboBoxItems = {"", "Homme", "Femme"};
        genreComboBox = new JComboBox<>(comboBoxItems);
        jpanel.add(genreComboBox,gbc);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        client.setGenre(genreComboBox.getItemAt(genreComboBox.getSelectedIndex()).toString());
