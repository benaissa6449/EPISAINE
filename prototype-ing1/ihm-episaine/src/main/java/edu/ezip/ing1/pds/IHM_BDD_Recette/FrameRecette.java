...
public class FrameRecette extends JFrame implements ActionListener {
    ...
    public FrameRecette() throws IOException, SQLException, InterruptedException {
    ...
    private void setTransitionPanel(){
        ...
        panelArray.add(new SelectPanelRecette());
        panelArray.add(new InsertPanelRecette());
